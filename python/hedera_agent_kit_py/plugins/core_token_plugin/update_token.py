...
from hiero_sdk_python import Client, PublicKey, TokenId
...
from hedera_agent_kit_py.shared.utils import (
...
async def check_validity_of_updates(
    ...
    Raises:
        ValueError: If a token is not found, the user lacks permission, or key updates are invalid.
    """
...
*IMPORTANT:* If the user provides multiple fields in a single request, 
