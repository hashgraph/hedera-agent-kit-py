...
TESTNET_ERC721_FACTORY_ADDRESS: str = (
...
def get_erc20_factory_address(ledger_id: LedgerId) -> str:
    address: str = ERC20_FACTORY_ADDRESSES.get(ledger_id.value)
    if not address:
