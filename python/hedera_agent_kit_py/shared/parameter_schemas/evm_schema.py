...
class CreateERC721Parameters(OptionalScheduledTransactionParams):
    ...
    base_uri: Annotated[str, Field(default="", description="The base URI for token metadata.")]
...
class CreateERC20Parameters(OptionalScheduledTransactionParams):
    ...
    decimals: Annotated[
        Optional[int],
        Field(default=18, ge=0, description="The number of decimals the token supports."),
    ]
    initial_supply: Annotated[
        Optional[int],
        Field(default=0, ge=0, description="The initial supply of the token."),
    ]
...
class TransferERC721Parameters(OptionalScheduledTransactionParams):
    ...
    from_address: Annotated[
        Optional[str],
        Field(default=None, description="Address from which the token will be transferred."),
    ]
...
class MintERC721Parameters(OptionalScheduledTransactionParams):
    ...
    to_address: Annotated[
        Optional[str],
        Field(default=None, description="Address to which the token will be minted."),
    ]
...
class ContractInfoQueryParameters(BaseModel):
