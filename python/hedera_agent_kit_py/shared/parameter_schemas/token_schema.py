...
class CreateFungibleTokenParameters(OptionalScheduledTransactionParams):
    ...
    initial_supply: Annotated[int, Field(description="The initial supply of the token.")] = 0
    supply_type: Annotated[
        int, Field(description="Supply type of the token. 0 for infinite, 1 for finite.")] = 1
    max_supply: Annotated[Optional[int], Field(description="The maximum supply of the token.")] = None
    decimals: Annotated[int, Field(description="The number of decimals.")] = 0
    treasury_account_id: Annotated[Optional[str], Field(description="The treasury account of the token.")] = None
    is_supply_key: Annotated[
        Optional[bool], Field(description="Determines if the token supply key should be set.")] = None
...
class AirdropFungibleTokenParameters(OptionalScheduledTransactionParams):
    ...
    source_account_id: Annotated[Optional[str], Field(description="The account to airdrop the token from.")] = None
    recipients: Annotated[List[AirdropRecipient], Field(min_length=1, description="Array of recipients.")]
...
class MintNonFungibleTokenParameters(OptionalScheduledTransactionParams):
    ...
    uris: Annotated[List[str], Field(max_length=10, description="An array of URIs hosting NFT metadata.")]


## TODO: adapt to the Python SDK Transaction Constructor impl
class MintNonFungibleTokenParametersNormalised(OptionalScheduledTransactionParamsNormalised):
    token_id: Annotated[str, Field(description="The id of the NFT class.")]
    metadata: Annotated[Optional[List[bytes]], Field(description="NFT metadata in bytes.")] = None
...
class TransferNonFungibleTokenWithAllowanceParameters(OptionalScheduledTransactionParams):
    ...
    transaction_memo: Annotated[Optional[str], Field(description="Optional transaction memo.")] = None
...
class TransferNonFungibleTokenWithAllowanceParametersNormalised(OptionalScheduledTransactionParamsNormalised):
    ...
    transaction_memo: Annotated[Optional[str], Field(description="Optional transaction memo.")] = None
    transfers: Annotated[List[dict], Field(description="List of NFT ID and receiver pairs.")]
...
class TransferFungibleTokenWithAllowanceParameters(OptionalScheduledTransactionParams):
    ...
    source_account_id: Annotated[str, Field(description="Account ID of the token owner.")]
    transfers: Annotated[List[dict], Field(min_length=1, description="Array of recipient transfers.")]
    transaction_memo: Annotated[Optional[str], Field(description="Optional transaction memo.")] = None
...
class TransferFungibleTokenWithAllowanceParametersNormalised(OptionalScheduledTransactionParamsNormalised):
    ...
    token_transfers: Annotated[List[TokenTransfer], Field(description="Resolved token transfers.")]
    approved_transfer: Annotated[dict, Field(description="Approved owner account and amount.")]
    transaction_memo: Annotated[Optional[str], Field(description="Optional transaction memo.")] = None
...
class DissociateTokenParameters(OptionalScheduledTransactionParams):
    ...
    account_id: Annotated[Optional[str], Field(description="Account to dissociate from, defaults to operator")] = None
    transaction_memo: Annotated[Optional[str], Field(description="Optional transaction memo")] = None
...
class UpdateTokenParameters(OptionalScheduledTransactionParams):
    ...
    treasury_account_id: Annotated[Optional[str], Field(description="New treasury account ID")] = None
    auto_renew_account_id: Annotated[Optional[str], Field(description="Auto renew account ID")] = None
    ...
    fee_schedule_key: Annotated[Optional[PublicKey], Field(description="Fee schedule key")] = None
    pause_key: Annotated[Optional[PublicKey], Field(description="Pause key")] = None
    metadata_key: Annotated[Optional[PublicKey], Field(description="Metadata key")] = None
...
class UpdateTokenParametersNormalised(OptionalScheduledTransactionParamsNormalised):
    ...
    token_memo: Annotated[Optional[str], Field(description="New token memo")] = None
    metadata: Annotated[Optional[bytes], Field(description="New token metadata")] = None
    treasury_account_id: Annotated[Optional[AccountId], Field(description="Resolved treasury account ID")] = None
    auto_renew_account_id: Annotated[Optional[AccountId], Field(description="Resolved auto renew account ID")] = None
    admin_key: Annotated[Optional[PublicKey], Field(description="Admin key")] = None
    supply_key: Annotated[Optional[PublicKey], Field(description="Supply key")] = None
    wipe_key: Annotated[Optional[PublicKey], Field(description="Wipe key")] = None
    freeze_key: Annotated[Optional[PublicKey], Field(description="Freeze key")] = None
...
class CreateNonFungibleTokenParameters(OptionalScheduledTransactionParams):
    ...
    treasury_account_id: Annotated[Optional[str], Field(description="Treasury account ID")] = None
...
class CreateNonFungibleTokenParametersNormalised(OptionalScheduledTransactionParamsNormalised):
    ...
    wipe_key: Annotated[Optional[PublicKey], Field(description="Wipe key")] = None
    pause_key: Annotated[Optional[PublicKey], Field(description="Pause key")] = None
    token_memo: Annotated[Optional[str], Field(description="Optional token memo")] = None


class AssociateTokenParameters(OptionalScheduledTransactionParams):
    account_id: Annotated[Optional[str], Field(description="Account to associate tokens with")] = None
    token_ids: Annotated[List[str], Field(min_length=1, description="Token IDs to associate")]
...
class ApproveNftAllowanceParameters(OptionalScheduledTransactionParams):
    owner_account_id: Annotated[Optional[str], Field(description="Owner account ID")] = None
    ...
    serial_numbers: Annotated[Optional[List[int]], Field(description="Serial numbers to approve")] = None
    transaction_memo: Annotated[Optional[str], Field(description="Optional transaction memo")] = None


## TODO: adapt to the Python SDK Transaction Constructor impl
class ApproveNftAllowanceParametersNormalised(OptionalScheduledTransactionParamsNormalised):
    nft_approvals: Annotated[Optional[List[dict]], Field(description="Resolved NFT approvals")] = None
    transaction_memo: Annotated[Optional[str], Field(description="Optional transaction memo")] = None
