...
class CreateNonFungibleTokenTool(BaseToolV2):
    ...
    async def core_action(
        self,
        normalized_params: CreateNonFungibleTokenParametersNormalised,
        client: Client,
        context: Context,
    ) -> Transaction:
        return HederaBuilder.create_non_fungible_token(normalized_params)
